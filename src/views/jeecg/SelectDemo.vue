        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="字典表下拉">
              <j-dict-select-tag v-model="formData.user" placeholder="请选择用户" dictCode="system_user,realname,id"/>
            </a-form-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="字典表下拉(带条件)">
              <j-dict-select-tag v-model="formData.user2" placeholder="请选择用户" dictCode="system_user,realname,id,username!='admin' order by create_time"/>
            </a-form-item>
          </a-col>
          ...
          <a-col :span="12">
            <a-form-item label="字典搜索(异步)">
              <j-search-select-tag
                ...
                dict="system_depart,depart_name,id"
                :async="true">
              </j-search-select-tag>
            </a-form-item>
          </a-col>
          ...
          <a-col :span="12">
            <a-form-item label="下拉树选择">
              <j-tree-select
                ...
                placeholder="请选择菜单"
                dict="system_permission,name,id"
                pidField="parent_id"
                pidValue=""
              />
            </a-form-item>
