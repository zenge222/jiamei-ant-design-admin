...
/*            customRender:function (text) {
		...
		url: {
          list: "/system/quartzJob/list",
          delete: "/system/quartzJob/delete",
          deleteBatch: "/system/quartzJob/deleteBatch",
          pause: "/system/quartzJob/pause",
          resume: "/system/quartzJob/resume",
          exportXlsUrl: "/system/quartzJob/exportXls",
          importExcelUrl: "/system/quartzJob/importExcel",
          execute: "/system/quartzJob/execute"
        },
      }
    },
    computed: {
