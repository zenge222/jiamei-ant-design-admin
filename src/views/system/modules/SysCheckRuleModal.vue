  ...
  export default {
    ...
    data() {
      return {
        ...
        validatorRules: {
          ...
          ruleCode: {
            rules: [
              ...
              { validator: (rule, value, callback) => validateDuplicateValue('system_check_rule', 'rule_code', value, this.model.id, callback) }
            ]
          },
        },
        tabs: {
        ...
        url: {
          add: '/system/checkRule/add',
          edit: '/system/checkRule/edit',
        },
      }
    },
    created() {
