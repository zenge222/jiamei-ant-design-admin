  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/system/user/departUserList",
          edit: "/system/user/editSysDepartWithUser",
          delete: "/system/user/deleteUserInDepart",
          deleteBatch: "/system/user/deleteUserInDepartBatch",
        }
      }
    },
    created() {
