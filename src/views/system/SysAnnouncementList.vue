  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/system/annountCement/list",
          delete: "/system/annountCement/delete",
          deleteBatch: "/system/annountCement/deleteBatch",
          releaseDataUrl: "/system/annountCement/doReleaseData",
          reovkeDataUrl: "/system/annountCement/doReovkeData",
          exportXlsUrl: "/system/annountCement/exportXls",
          importExcelUrl: "/system/annountCement/importExcel",
        },
      }
    },
    computed: {
    ...
    methods: {
      ...
      syncHeadNotic(anntId){
        getAction("/system/annountCement/syncNotic",{anntId:anntId})
      },
    }
  }
</script>
