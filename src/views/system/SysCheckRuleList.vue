  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/system/checkRule/list',
          delete: '/system/checkRule/delete',
          deleteBatch: '/system/checkRule/deleteBatch',
          exportXlsUrl: '/system/checkRule/exportXls',
          importExcelUrl: '/system/checkRule/importExcel',
        },
      }
    },
    computed: {
