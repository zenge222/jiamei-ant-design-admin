    ...
    data() {
      return {
        ...
        url: {
          ...
          exportXlsUrl: "/system/dict/exportXls",
          importExcelUrl: "/system/dict/importExcel",
          refleshCache: "/system/dict/refleshCache",
          queryAllDictItems: "/system/dict/queryAllDictItems",
        },
      }
    },
    computed: {
