  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/system/category/rootList",
          childList: "/system/category/childList",
          delete: "/system/category/delete",
          deleteBatch: "/system/category/deleteBatch",
          exportXlsUrl: "/system/category/exportXls",
          importExcelUrl: "/system/category/importExcel",
        },
        expandedRowKeys:[],
