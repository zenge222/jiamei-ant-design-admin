  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: '/system/fillRule/list',
          test: '/system/fillRule/testFillRule',
          delete: '/system/fillRule/delete',
          deleteBatch: '/system/fillRule/deleteBatch',
          exportXlsUrl: '/system/fillRule/exportXls',
          importExcelUrl: '/system/fillRule/importExcel',
        },
      }
    },
    computed: {
